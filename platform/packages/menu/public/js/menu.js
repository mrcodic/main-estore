  ...
  return _createClass(MenuNestable, [{
    ...
    value: function handleNestableMenu() {
      ...
      $(document).on('click', '.box-links-for-menu .btn-add-to-menu', function (e) {
        ...
        if (parent.attr('id') === 'external_link') {
          ...
          parent.find('.list-item li.active').each(function (index, el) {
            ...
            var params = {};
            params.reference_type = sanitize_html__WEBPACK_IMPORTED_MODULE_0___default()($label.data('reference-type'));
            params.reference_id = sanitize_html__WEBPACK_IMPORTED_MODULE_0___default()($label.data('reference-id'));
            params.title = sanitize_html__WEBPACK_IMPORTED_MODULE_0___default()($label.data('title'));
            params.menu_id = sanitize_html__WEBPACK_IMPORTED_MODULE_0___default()($label.data('menu-id'));
      ...
      var createMenuNode = function createMenuNode(params, current, parent) {
        $httpClient.make().get(route('menus.get-node'), {
          data: params
        }).then(function (_ref) {
          var data = _ref.data;
