  ...
  $('.btn_select_gallery').rvMedia({
    ...
    onSelectFiles: function onSelectFiles(files) {
      ...
      $.each(files, function (index, file) {
        $('.list-photos-gallery .row').append('<div class="col-md-2 col-sm-3 col-4 photo-gallery-item" data-id="' + (last_index + index) + '" data-img="' + file.url + '" data-description=""><div class="gallery_image_wrapper"><img src="' + file.thumb + '" alt="image" loading="lazy"/></div></div>');
      });
      initSortable();
      updateItems();
