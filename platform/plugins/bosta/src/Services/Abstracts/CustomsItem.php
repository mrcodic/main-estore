...
class Bosta_CustomsItem extends Bosta_ApiResource
{
    /**
     ...
     *
     * @return Bosta_CustomsItem Create a customs item.
     */
     ...
     * @param array|null $params
     *
     * @return Bosta_Retrieve Get a customs item.
     */
     ...
     * @param array|null $params
     *
     * @return Bosta_All Get all the customs items.
     */
