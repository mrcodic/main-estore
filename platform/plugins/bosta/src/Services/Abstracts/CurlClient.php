...
class CurlClient
{
     ...
     * @throws Bosta_ApiConnectionError
     */
    public function handleCurlError($errno, $message)
    {
        ...
        switch ($errno) {
            ...
            case CURLE_OPERATION_TIMEOUTED:
                $msg = "Could not connect to Bosta ($apiBase).";
                break;
            default:
                $msg = "Unexpected error communicating with Bosta.  " . "If this problem persists,";
        }
        $msg .= " let us know by contacting us through our contact form.";
        $msg .= "\n\n(Network error [errno $errno]: $message)";
        throw new Bosta_ApiConnectionError($msg);
    }
}
