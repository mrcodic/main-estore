...
class Bosta_Batch extends Bosta_ApiResource
{
    /**
    ...
    */
     ...
     *
     * @return Bosta_Batch Create a batch shipment object
     */
     ...
     * @param string|null $apiKey
     *
     * @return Bosta_Retrieve Retrieves a batch shipment
     */
     ...
     * @param string|null $apiKey
     *
     * @return Bosta_Add Adds shipments to a batch
     */
     ...
     * @param string|null $apiKey
     *
     * @return Bosta_Remove Removes shipments from a batch
     */
     ...
     * @param string|null $apiKey
     *
     * @return Bosta_Purchase Attempts to purchase a batch shipment
     */
