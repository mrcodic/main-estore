...
return [
    ...
    'note_2' => 'Enabled "Load countries, states, cities from plugin location?" and "Enable Zip Code?" for Bosta to work correctly',
    ...
    'note_5' => 'Bosta only allows to create transactions with shipment/rate within 24 hours, if more than 24 hours, please update the rate again',
    ...
    'activate' => 'Activate',
    'disabled_in_demo_mode' => 'You cannot update Bosta settings in demo mode!',
    'parcel' => 'Parcel',
    ...
    'not_available_in_cod_payment_method' => "Bosta options won't be shown if the selected payment method is COD!",
];
