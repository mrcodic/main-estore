...
class ReviewSeeder extends BaseSeeder
{
    public function run(): void
    {
        ...
        $reviews = [
            ...
            'This web app is really good in design, code quality & features. Besides, the customer support provided by the Pixbyte team was really fast & helpful. You guys are awesome!',
            ...
            'I Love this Script. I also found how to add other fees. Now I just wait the BIG update for the Marketplace with the Bulk Import. Just do not forget to make it to be Multi-language for us the Pixbyte Fans.',
            'The best ecommerce CMS! Excellent coding! best support service! Thank you so much..... I really like your hard work.',
            'Second or third time that I buy a Pixbyte product, happy with the products and support. You guys do a good job :)',
            ...
            'Perfect +++++++++ i love it really also i get to fast ticket answers... Thanks Lot Pixbyte Teams',
            ...
            'Amazing code, amazing support. Overall, im really confident in Pixbyte and im happy I made the right choice! Thank you so much guys for coding this masterpiece',
            ...
            'It\'s not my first experience here on Codecanyon and I can honestly tell you all that Pixbyte puts a LOT of effort into the support. They answer so fast, they helped me tons of times. REALLY by far THE BEST EXPERIENCE on Codecanyon. Those guys at Pixbyte are so good that they deserve 5 stars. I recommend them, I trust them and I can\'t wait to see what they will sell in a near future. Thank you Pixbyte :)',
