...
var MainCheckout = /*#__PURE__*/function () {
  ...
  return _createClass(MainCheckout, [{
    ...
    value: function init() {
      ...
      var customerShippingAddressForm = '.customer-address-payment-form .address-form-wrapper';
      var customerBillingAddressForm = '.customer-billing-address-form';
      var customerTaxInformationForm = '.customer-tax-information-form';
      ...
      var validatedFormFields = function validatedFormFields() {
        ...
        var validated = true;
        $.each($(document).find('.form-control[required]'), function (index, el) {
      ...
      $(document).on('change', customerShippingAddressForm + ' .address_country', function (event) {
        setTimeout(function () {
          var _self = $(event.currentTarget);
      ...
      $(document).on('change', customerBillingAddressForm + ' #billing_address_same_as_shipping_address', function (event) {
        var _self = $(event.currentTarget);
      ...
      $(document).on('change', customerTaxInformationForm + ' #with_tax_information', function (event) {
        var _self = $(event.currentTarget);
