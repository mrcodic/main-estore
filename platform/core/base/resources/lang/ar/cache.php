...
return [
    ...
    'commands' => [
        'clear_cms_cache' => [
            'title' => 'مسح كافة ذاكرة التخزين المؤقت CMS',
            'description' => 'مسح التخزين المؤقت لـ CMS: التخزين المؤقت لقاعدة البيانات، الكتل الثابتة... قم بتشغيل هذا الأمر عندما لا ترى التغييرات بعد تحديث البيانات.',
