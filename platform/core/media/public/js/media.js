  ...
  return _createClass(ActionsService, null, [{
    ...
    value: function processAction(data) {
      ...
      $httpClient.make().post(RV_MEDIA_URL.global_actions, data).then(function (_ref) {
        ...
        _MessageService__WEBPACK_IMPORTED_MODULE_2__.MessageService.showMessage('success', data.message, _Helpers_Helpers__WEBPACK_IMPORTED_MODULE_1__.Helpers.trans('message.success_header'));
        if (callback) {
          callback(data);
        }
      })["finally"](function () {
...
var FolderService = /*#__PURE__*/function () {
  ...
  return _createClass(FolderService, [{
    ...
    value: function create(folderName) {
      ...
      $httpClient.make().post(RV_MEDIA_URL.create_folder, {
        ...
        return _Helpers_Helpers__WEBPACK_IMPORTED_MODULE_3__.Helpers.hideAjaxLoading();
      });
    }
  }, {
    key: "changeFolder",
